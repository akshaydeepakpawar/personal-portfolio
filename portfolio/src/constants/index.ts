...
export const About_text = `I'm a Full Stack Developer who enjoys building real-world applications from scratch and understanding how things work under the hood. I've worked on projects like a coding platform with real-time code execution and an AI chat application integrating multiple models.
