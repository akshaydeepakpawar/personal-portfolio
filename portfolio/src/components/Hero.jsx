      ...
      <div className="flex flex-wrap">
        <div className="w-full lg:w-1/2">
          ...
          <button
            ...
            className="cursor-pointer group relative inline-flex items-center justify-center px-7 py-3 rounded-xl border border-neutral-700 bg-neutral-900 text-white font-medium tracking-wide overflow-hidden transition duration-300 hover:border-white hover:shadow-[0_0_25px_rgba(255,255,255,0.15)]"
          >
